...
const About = () => {
    return (
        ...
        <main>
            ...
            <img src='/book_scan.png' alt='bog bliver scannet'></img>
            </section>
            <section id='owner_section'>
                <div id='portrait_wrapper'>
                    <img src='/portrait_placeholder.jpg'></img>
                ...
                <img id='work_img' src='/placeholder.jpg'></img>
            </section>
            <section id='vision_section'>
                <div id='vision_wrapper'>
                <h2>Visioner for boss</h2>
